...
public class Button
    ...
    public void drawScreen(GuiGraphics context, int mouseX, int mouseY, float partialTicks) {
        ...
        RoundedUtil.rect(context, this.x, this.y, this.width, this.height - 0.5f, 2, getState() ? new Color(color.getRed(), color.getGreen(), color.getBlue(), (int) (120 + animation.getCurrent() * 40)) : new Color(40, 40, 40, (int) (150 + animation.getCurrent() * 50)));
