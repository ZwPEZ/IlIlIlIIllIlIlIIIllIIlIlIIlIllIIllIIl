...
void Custom::RenderTabs(int& selected_tab, const std::vector<TabInfo>& tabs, ImFont* icon_font)
{
    ...
    // Softer, more prominent glow
    ImU32 glow_color_top = ImGui::ColorConvertFloat4ToU32(ImVec4(Theme::Accent[0], Theme::Accent[1], Theme::Accent[2], 0.4f));
    ...
    draw_list->AddRectFilledMultiColor(
        ImVec2(indicator_pos_x - 10.0f, indicator_y - 12.0f),
        ImVec2(indicator_pos_x + indicator_width + 10.0f, indicator_y + indicator_height),
        glow_color_top,
        glow_color_top,
        glow_color_bottom,
        glow_color_bottom
